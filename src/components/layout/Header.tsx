...
export function Header({ user }: { user: { name: string; email: string } }) {
  return (
    <header className="hidden md:flex md:pl-64 sticky top-0 z-20 items-center justify-end gap-2 h-16 pr-8 border-b border-stone-200 dark:border-stone-800 bg-white/95 dark:bg-stone-900/95 backdrop-blur">
      <a
        href="/api/export"
